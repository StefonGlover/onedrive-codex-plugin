...
- Use `onedrive_word_get_document`, `onedrive_excel_get_workbook`, or `onedrive_powerpoint_get_presentation` to ground paragraphs, tables, cells, formulas, slide indexes, shape IDs, notes, and geometry before native edits.
...
- Word native operations cover text replacement, paragraph text/style/insertion, table cells, and content controls. Excel covers cells, formulas, ranges, clearing, styles, sheet rename, and defined names. PowerPoint covers text, geometry, table cells, notes, and slide duplicate/delete/reorder.
