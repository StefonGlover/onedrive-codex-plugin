...
- Word native operations cover text replacement, paragraphs, table insertion/cells, content controls, hyperlinks, and comments; tracked-change markup is refused. Excel covers cells, formulas, ranges, clearing, styles, number formats, sheet rename, defined names, and recalculation-on-open. PowerPoint covers text, styling, text boxes, geometry, shape deletion, raster-image replacement, table cells, notes, and slide duplicate/delete/reorder.
