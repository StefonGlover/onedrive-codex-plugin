...
const goldenPrompts = [
  ...
  { prompt: "Rename this file without moving it", tool: "onedrive_rename", cues: ["change the name", "without changing", "newname", "expectedid or expectedname"] },
  { prompt: "Move this workbook into Archive", tool: "onedrive_move", cues: ["different parent folder", "destinationparentitemid", "expectedid or expectedname"] },
  { prompt: "Copy this document and keep the original", tool: "onedrive_copy", cues: ["leaving the source in place", "waitforcompletion", "expectedid or expectedname"] },
