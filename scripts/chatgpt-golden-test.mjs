...
const goldenPrompts = [
  { prompt: "Find my 2026 family budget workbook", tool: "search", cues: ["find", "keywords"] },
  ...
  { prompt: "Rename this file without moving it", tool: "onedrive_rename", cues: ["change the name", "without changing"] },
  { prompt: "Move this workbook into Archive", tool: "onedrive_move", cues: ["different parent folder"] },
  { prompt: "Copy this document and keep the original", tool: "onedrive_copy", cues: ["leaving the source in place"] },
  { prompt: "Create a view-only sharing link", tool: "onedrive_create_sharing_link", cues: ["shareable", "link"] },
  { prompt: "Give these named people edit access", tool: "onedrive_invite_permission", cues: ["specific named recipients"] },
  { prompt: "Remove this sharing permission", tool: "onedrive_revoke_permission", cues: ["revoke", "permission id"] },
